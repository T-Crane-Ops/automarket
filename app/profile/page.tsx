      ...
      {error ? (
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <span className="font-medium">Current Period Ends:</span> {new Date(subscription.current_period_end).toLocaleDateString()}
            </div>
            <div className="space-y-1">
              <span className="font-medium">Next Payment:</span> {subscription.cancel_at_period_end ? 'None (Canceling)' : new Date(subscription.current_period_end).toLocaleDateString()}
            </div>
          </div>
          ...
          {isCancelModalOpen && (
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
              <div className="bg-background/80 border border-primary/20 backdrop-blur-lg rounded-lg p-6 max-w-md w-full shadow-xl">
    ...
    >
      <div>
        {paymentStatus === 'success' && (
          <Alert variant="success" className="mb-8 fixed top-4 right-4 w-auto z-50 max-w-md">
        ...
        <EnhancedProfilePage 
          subscriptionComponent={<SubscriptionSection />} 
        />
      </div>
    </ErrorBoundary>
  );
